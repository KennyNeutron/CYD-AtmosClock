//  Use the OpenWeather library: https://github.com/KennyNeutron/OpenWeather
...
const String latitude =  "your_latitiude"; // 90.0000 to -90.0000 negative for Southern hemisphere
const String longitude = "your_longitude"; // 180.000 to -180.000 negative for West
