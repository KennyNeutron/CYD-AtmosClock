...
// Zone reference "GMT+8" (e.g. Philippines, China, Western Australia, etc.)
TimeChangeRule GMTPlus8Std = {"GMT+8", Last, Sun, Oct, 2, 480}; //UTC + 8 hours
Timezone GMTPlus8(GMTPlus8Std, GMTPlus8Std);
