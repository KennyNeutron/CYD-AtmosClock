...
// https://github.com/KennyNeutron/TFT_eSPI
...
// on (KennyNeutron) the Arduino forum.
...
// Created by: KennyNeutron  5/3/17
// Updated by: KennyNeutron 12/3/17
// Version: 0.07
...
void drawWindow()
{
  ...
  textSize(20);
  fill(0);
  text("KennyNeutron's TFT image viewer", width/2, height-6);
